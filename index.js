...
function generateSeedWindow(parentWindow) {
    const win = new BrowserWindow({
        ...
        webPreferences: {
            ...
            sandbox: false,
            preload: path.resolve(__dirname, 'app', 'server', 'promptpre.js')
        }
    })

    win.loadURL(path.join(__dirname, 'app', "modules", "prompt", "index.html"))
...
app.whenReady().then(() => {
    ...
    const mainWin = new BrowserWindow({
        ...
        webPreferences: {
            ...
            contextIsolation: false,
            devTools: true,
            preload: path.resolve(__dirname, 'app', 'server', 'mainpre.js'),
        }
    })
